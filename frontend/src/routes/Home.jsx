...
//   //         <h1 className="text-5xl font-bold m-5">BAGHCHAL</h1>
//   //         <p className="text-xl opacity-80 m-2">
//   //           Experience the traditional Nepali strategy game where tigers hunt
//   //           and goats defend. A timeless battle of wits that has entertained
//   //           generations.
//   //         </p>
//   //         <div className="h-80 w-80  bg-blue-100">
    ...
    <div className="font-sans text-gray-800 bg-gray-100">
        ...
        <div className="container mx-auto px-5 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Experience the traditional Nepali strategy game where tigers hunt
              and goats defend. A timeless battle of wits that has entertained
              generations across Nepal.
            </p>
            {/* game buttons container  */}
            <div className="flex flex-col space-y-4 max-w-xs">
              <button className="btn bg-gray-800 text-white rounded-lg py-3 px-6 font-semibold hover:bg-gray-900 transition">
                Create Game
              </button>
              <button className="btn bg-gray-800 text-white rounded-lg py-3 px-6 font-semibold hover:bg-gray-900 transition">
                Join Game
      ...
      <section id="rules" className="py-16 bg-gray-100">
        <div className="container mx-auto px-5">
          <h2 className="text-3xl font-bold text-center mb-12">Quick Rules</h2>
